...
public class MenuAdminFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel38.setBounds(120, 60, 50, 22);
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thống Kê", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24))); // NOI18N
        ...
        searchButton.setBackground(new java.awt.Color(255, 190, 108));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(SearchdateTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 349, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(searchButton, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)))
                .addGap(15, 15, 15)
        ...
        jPanel4.add(jPanel2);
        jPanel2.setBounds(6, 30, 853, 81);

        refreshButton.setBackground(new java.awt.Color(255, 190, 108));
        refreshButton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        refreshButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/refresh1.png"))); // NOI18N
        ...
        refreshButton.setBounds(610, 210, 250, 50);

        chiTietButton.setBackground(new java.awt.Color(255, 190, 108));
        chiTietButton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        chiTietButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/bill2.png"))); // NOI18N
        ...
        jPanel4.add(chiTietButton);
        chiTietButton.setBounds(609, 148, 250, 50);

        listBillTable.setBackground(new java.awt.Color(255, 216, 148));
        ...
        if (listBillTable.getColumnModel().getColumnCount() > 0) {
            ...
            listBillTable.getColumnModel().getColumn(1).setMinWidth(200);
            listBillTable.getColumnModel().getColumn(1).setPreferredWidth(200);
            listBillTable.getColumnModel().getColumn(1).setMaxWidth(200);
        }

        jPanel4.add(jScrollPane2);
        jScrollPane2.setBounds(6, 148, 588, 230);

        XoaBillButton.setBackground(new java.awt.Color(255, 190, 108));
        XoaBillButton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        XoaBillButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/xoato.png"))); // NOI18N
        ...
        jPanel4.add(XoaBillButton);
        XoaBillButton.setBounds(610, 270, 250, 50);

        XoatatcaBill.setBackground(new java.awt.Color(255, 190, 108));
        XoatatcaBill.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        XoatatcaBill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/xoahan.png"))); // NOI18N
        ...
        jPanel4.add(XoatatcaBill);
        XoatatcaBill.setBounds(610, 330, 250, 50);
        jPanel4.add(jSeparator4);
        jSeparator4.setBounds(6, 117, 863, 2);

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel14.setText("Danh Sách Hóa Đơn");
        jPanel4.add(jLabel14);
        jLabel14.setBounds(200, 125, 152, 17);

        jLabel19.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel19.setText("Thống Kê");
        jPanel4.add(jLabel19);
        jLabel19.setBounds(380, 0, 130, 30);

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/anhgo.jpg"))); // NOI18N
        jPanel4.add(jLabel17);
        jLabel17.setBounds(0, 0, 880, 400);

        jTabbedPane1.addTab("Thống kê", new javax.swing.ImageIcon(getClass().getResource("/view/thongke.png")), jPanel4); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, 878, Short.MAX_VALUE)
        );
